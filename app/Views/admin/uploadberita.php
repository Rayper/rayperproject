                ...
                <div class="card">
                    <form method="post" action="<?= site_url('Admin/prosesberita') ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" placeholder="Nama Pengguna" name="nama" class="form-control form-control-sm col-lg-5 col-sm-5" value="<?= session()->get('fullname'); ?>" readonly>
                        </div>

                        <div class="form-group row">
                            <label for="inputJudulBerita" class="col-sm-2 col-lg-2 form-label">Judul Berita</label>
                            <input type="text" class="form-control form-control-sm col-lg-5 col-sm-5" name="Judul" id="judulBerita">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control form-control-sm col-lg-5 col-sm-5" name="tanggalupload" value="<?= $date ?>">
                        </div>

                        <div class="form-group row">
                            <label for="uploadThumbnailBerita" class="col-sm-2 col-lg-2 form-label">Upload Thumbnail</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="Thumbnail" id="thumbnailBerita">
                        </div>
                        ...
                        <div class="form-group row">
                            <button class="btn btn-upload d-grid gap-2 col-lg-1 col-sm-2 mx-auto" type="submit" onClick="return sukses()">Unggah</button>
                        </div>
