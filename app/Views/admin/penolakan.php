                        ...
                        <form method="post" action="<?= site_url('Admin/ubahstatus/'.$dt['invoice_id']) ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="custom control custom-switch ml-7">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="statuspembayaran" value="3" name="status">
                                    <label for="statuspembayaran" class="custom-control-label">Tolak Pemesanan</label>
                                </div>
                                <br>
