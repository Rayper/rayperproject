                    ...
                    <div class="table-responsive">
                        <table class="table table-hover my-5">
                            ...
                            <?php
                                ...
                                <?php else : ?>
                                    <a href="/member/cekpembayaran/<?= $dt['invoice_id'] ?>" class="btn btn-detail btn-sm px-3">Cek Pembayaran</a>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <a href="/member/detailinvoice/<?= $dt['invoice_id'] ?>" class="btn btn-secondary btn-sm px-3">Detail</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>  
                            </tbody>
