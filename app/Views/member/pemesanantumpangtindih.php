...
<head>
    ...
    <title>Pemesanan Makam< Tumpagn Tindih</title>
                ...
                <div class="card">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control form-control-sm col-lg-5 col-sm-5" name="alamatAhliWaris" <?= ($validation->hasError('fullname')) ? 'is-invalid' : '' ; ?>">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control form-control-sm col-lg-5 col-sm-5" name="NoHPAhliWaris" <?= ($validation->hasError('fullname')) ? 'is-invalid' : '' ; ?>">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="suratKematian" accept=".pdf, .jpg, .png, .jpeg">
                        </div>
                        
                        <div class="form-group row">
                            <label for="uploadKTPAlm" class="col-sm-2 col-lg-2 form-label">KTP Alm/Almh</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="KTPAlm" accept=".pdf, .jpg, .png, .jpeg">
                        </div>
                        
                        <div class="form-group row">
                            <label for="uploadKKAlm" class="col-sm-2 col-lg-2 form-label">KK Alm/Almh</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="KKAlm" accept=".pdf, .jpg, .png, .jpeg">
                        </div>

                        <div class="form-group row">
                            <label for="uploadKTPAhliWaris" class="col-sm-2 col-lg-2 form-label">KTP Ahli Waris</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="KTPAhliWaris" accept=".pdf, .jpg, .png, .jpeg">
                        </div>

                        <div class="form-group row">
                            <label for="uploadKKAhliWaris" class="col-sm-2 col-lg-2 form-label">KK Ahli Waris</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="KKAhliWaris" accept=".pdf, .jpg, .png, .jpeg">
                        </div>

                        <div class="form-group row">
                            <label for="uploadKTPSaksi" class="col-sm-2 col-lg-2 form-label">KTP Saksi/Kerabat</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="KTPSaksi" accept=".pdf, .jpg, .png, .jpeg">
                        </div>

                        <div class="form-group row">
                            <label for="uploadKKSaksi" class="col-sm-2 col-lg-2 form-label">KK Saksi/Kerabat</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="KKSaksi" accept=".pdf, .jpg, .png, .jpeg">
                        </div>

                        <div class="form-group row">
                            <label for="suratpernyataan" class="col-sm-2 col-lg-2 form-label">Surat Pernyataan Tumpang Tindih</label>
                            <input type="file" class="form-control-file col-lg-5 col-sm-5" name="suratpernyataan" accept=".pdf, .jpg, .png, .jpeg">
                        </div>
