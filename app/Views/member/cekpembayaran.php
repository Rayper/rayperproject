            ...
            <section class="cek-pembayaran">
                <div class="card">
                    ...
                    <?php foreach ($datainvoice as $dt) : ?>
                        <form method="post" action="<?= site_url('Member/uploadbukti/'.$dt['invoice_id']) ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                <p class="judul">Silahkan Upload Bukti Pembayaran dengan pembayaran ke Nomor Rekening 527129846 (BCA An. KOBER)</p>
                                <div class="form-group row">
                                    <input type="hidden" name="invoice_id" value="<?= $dt['invoice_id']; ?>">
                                    <input type="file" class="form-control-file col-sm-6" name="buktipembayaran" accept=".pdf, .jpg, .png, .jpeg" required>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
