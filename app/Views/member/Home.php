...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('/css/homealogin.css'); ?>">
</head>
<body>
    <!-- navbar -->
                ...
                <ul class="list-procedure">
                    ...
                    <li class="media my-2">
                        ...
                        <div class="media-body">
                            ...
                            <p class="body-description">Temukan TPU disekitar anda atau TPU yang diinginkan di fitur Cari TPU, 
                    ...
                    <li class="media my-2">
                        ...
                        <div class="media-body">
                            ...
                            <p class="body-description">Isi dan lengkapi data ahli waris dan jenazah, serta upload dokumen yang diperlukan
                    ...
                    <li class="media my-2">
                        ...
                        <div class="media-body">
                            ...
                            <h2 class="body-heading">Mendapatkan Invoice Pemesanan / Izin Penggunaan Tanah Makam (IPTM)</h2>
                            <p class="body-description">Setelah mengisi form pemesanan kamu mendapatkan invoice atau IPTM, lanjut melakukan pembayaran
