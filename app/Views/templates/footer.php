<footer class="section-footer mb-6">
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-lg-9">
                <h4 class="heading-contact">Hubungi Kami</h4>
            ...
            <div class="col-lg-3">
                ...
                <button type="button" class="btn btn btn-feedback px-4 py-2 ml-5" data-toggle="modal"
    ...
    <div class="container">
        <div class="row">
            <div class="col-copyright col-lg-9 pt-3">
                <p>Copyrights © 2021 All Rights Reserved </p>
            </div>
            <div class="col-lg-3 pt-2 pb-2">
                <a href="https://www.facebook.com/profile.php?id=100070556821027" target="_blank">
                    <img src="/img/Facebook.png" alt="Icon Facebook">
                </a>
                <a href="https://twitter.com/koberapps" target="_blank">
                    <img src="/img/Twitter.png" alt="Icon Twitter">
                </a>
                <a href="https://www.linkedin.com/in/kober-apps-8b6595216/" target="_blank">
                    <img src="/img/Linkedin.png" alt="Icon Linkedin">
                </a>
                <a href="https://www.instagram.com/koberapps/" target="_blank">
