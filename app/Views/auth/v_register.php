            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 px-5 pt-5 justify-content-center">
                    ...
                    <?= csrf_field();?>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="col-lg-8">
                                <input type="text" name="fullname" placeholder="Nama Pengguna" class="form-control mx-3 mb-1<?= ($validation->hasError('fullname')) ? 'is-invalid' : '' ; ?>" value="<?= old('fullname'); ?>" required>
